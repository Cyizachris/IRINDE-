...
@media (max-width: 880px) {
 ...
 <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css">
    ...
    <tr>
    <th class="umutwe" ><font color="white" size="2"> <a href="home.php" target="_self"><b>AHABANZA</b></a></font></th>  
    <th class="umutwe" ><font color="white" size="2"> <a href="inama.php" target="_self"> <b>UMVA INAMA</b></a></font></th>
    <th class="umutwe" ><font color="white" size="2">  <a href="isuzume.php" target="_self"><b>ISUZUME</b></a></font></th>
    </tr>
    </div>
    </table> 
    <p><font color="lightblack" size="10" family: "Times New Roman", Times, serif;><marquee behavior="slide" direction="left">Menya indwara zitandura n'uko wakwita ku buzima bwawe!</marquee></font></p>
    <table border="0" width="100%" height="8%">
    <tr>
    ...
    <tr>
    <td width="50%"><div>
        <img src="../images/asma.jpg" alt="ijisho">
    <img src="../images/nia.jpg" alt="ijisho"> 
    <img src="..images/mipa.jpg" alt="ijisho">
    </td>
