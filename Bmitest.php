...
<div class="reg">
  <p id="nice">IPIMISHE BMI<p></p>
  <form method="POST">
  <input type="number" name="height" placeholder="ibiro muri kilogarama"><br>
  <input type="number" name="weight" placeholder="uburebure muri metero"><br>
