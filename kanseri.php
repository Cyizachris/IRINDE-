...
@media (max-width: 880px) {
 ...
 font-size: auto;
    ...
    <tr>
    <th class="umutwe" width="10%"><font color="white" size="2"> <a href="index.php" target="_self"><b>AHABANZA</b></a></font></th>
    ...
    <tr>
    <td width="50%"><div>
        <img src="../images/bii.jpg" alt="ijisho">
    <img src="../images/nii.jpg" alt="ijisho"> 
